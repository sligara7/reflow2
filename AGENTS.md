...
python3 tools/test_run_to_files.py                      # a real test run becomes per-file outcomes reconcile_verification reads
...
**Shipping at v0.68.0.** The deterministic core, the agent-native MCP surface, and the consumer
