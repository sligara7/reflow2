...
- BL-26 S half (DOCUMENTS write side: core fn + tool; traversal decision stays open) — @ajs — since 2026-07-20 — crates/reflow2-core/src/artifact.rs, reflow2-mcp/src/service.rs, tests
