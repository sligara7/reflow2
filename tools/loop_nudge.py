...
SESSION_START_TEXT = (
    ...
    "not installed: get_skill fetches one, list_skills names them all, find_skills "
    "finds one from a sentence in your own words. When you "
...
COUNT_ADVICE = (
    ...
    ("answered_with_open_gap",
     ...
     "read them (open_questions) — write in what is missing, or leave a gap that is genuinely blocked"),
